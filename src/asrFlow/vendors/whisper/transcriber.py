...
_BACKEND_CLASS_PATHS: dict[BackendName, tuple[str, str]] = {
    "ct2": ("asrFlow.vendors.whisper.backends.ct2", "CT2Transcriber"),
    "hf_generate": ("asrFlow.vendors.whisper.backends.hf_generate", "GenerateTranscriber"),
    "hf_pipeline": ("asrFlow.vendors.whisper.backends.hf_pipeline", "PipelineTranscriber"),
}
